...
class LoadSamplesSmallObob2Tests(TracebaseTestCase):
    ...
    def setUpTestData(cls):
        ...
        call_command(
            "load_samples",
            infile="DataRepo/tests/data/small_obob2/samples_table.tsv",
            headers="DataRepo/tests/data/small_obob2/sample_headers.yaml",
        )
        ...
        call_command(
            "load_samples",
            infile="DataRepo/tests/data/small_obob2/serum_lactate_sample_table_new.tsv",
            headers="DataRepo/tests/data/small_obob2/sample_headers.yaml",
        )
    ...
    def test_ls_new_researcher_and_aggregate_errors(self):
        ...
        with self.assertRaises(AggregatedErrors) as ar:
            call_command(
                "load_samples",
                infile="DataRepo/tests/data/small_obob2/serum_lactate_sample_table_han_solo_new.tsv",
                headers="DataRepo/tests/data/small_obob2/sample_headers.yaml",
            )
        aes = ar.exception
    ...
    def test_ls_new_researcher_confirmed(self):
        with self.assertRaises(AggregatedErrors) as ar:
            call_command(
                "load_samples",
                infile="DataRepo/tests/data/small_obob2/serum_lactate_sample_table_han_solo_v3.tsv",
                headers="DataRepo/tests/data/small_obob2/sample_table_headers_v3.yaml",
            )
        aes = ar.exception
