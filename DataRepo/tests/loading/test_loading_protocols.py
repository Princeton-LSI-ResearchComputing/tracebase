...
class ProtocolLoadingTests(TracebaseTestCase):
    ...
    def test_load_protocols_xlxs(self):
        ...
        call_command(
            "load_protocols",
            protocols="DataRepo/data/examples/small_dataset/small_obob_animal_and_sample_table.xlsx",
        )
    ...
    def test_load_protocols_tsv_with_workarounds(self):
        ...
        call_command(
            "load_protocols",
            protocols="DataRepo/data/examples/testing_data/protocols/protocols_with_workarounds.tsv",
        )
    ...
    def test_load_protocols_with_bad_examples(self):
        ...
        with self.assertRaises(AggregatedErrors) as ar:
            call_command(
                "load_protocols",
                protocols="DataRepo/data/examples/testing_data/protocols/protocols_with_errors.tsv",
            )
        aes = ar.exception
