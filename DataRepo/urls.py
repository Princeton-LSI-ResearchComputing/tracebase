...
urlpatterns = [
    ...
    re_path("^samples/(?P<animal_id>\d+$)/", views.SampleListView.as_view(), name="sample_list"),
    ...
    re_path("^peakgroups/(?P<ms_run_id>\d+\+$)/", views.PeakGroupListView.as_view(), name="peakgroup_list"),
    path("peakgroups/<int:pk>/", views.PeakGroupDetailView.as_view(), name="peakgroup_detail"),
    path("peakdata/", views.PeakDataListView.as_view(), name="peakdata_list"),
    re_path("^peakdata/(?P<peak_group_id>\d+\+$)/", views.PeakDataListView.as_view(), name="peakdata_list"),
]
