...
urlpatterns = [
    ...
    path("task_status/<str:task_id>/", views.get_advsrch_download_progress, name='task_status'),
    path("task_output/<str:task_id>/", views.get_advsrch_download_output, name='task_output'),
]
