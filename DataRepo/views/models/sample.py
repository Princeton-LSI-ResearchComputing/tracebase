        ...
        super().__init__(
            ...
            BSTColumnGroup(
                BSTColumn(
                    ...
                    many_related_sort_fld="animal__infusate__tracer_links__tracer__name",
                    header="Tracer(s)",
                ),
                BSTColumn(
                    ...
                    many_related=True,
                    many_related_model="animal__infusate__tracer_links",
                    many_related_sort_fld="animal__infusate__tracer_links__tracer__compound__name",
            ...
            BSTColumnGroup(
                BSTColumn(
                    ...
                    many_related_sort_fld="msrun_samples__msrun_sequence__researcher",
                ...
                BSTColumn(
                    ...
                    many_related_sort_fld="msrun_samples__msrun_sequence__date",
                    many_related_model="msrun_samples",
                    header="MSRun Date",
                ),
                BSTColumn(
                    ...
                    many_related=True,
                    field="msrun_samples",
                    many_related_sort_fld="msrun_samples__pk",
