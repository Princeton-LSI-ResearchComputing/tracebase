# Generated by Django 3.1.8 on 2021-05-13 15:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="The number of labeled atoms (M+) observed "
                        "relative to the presumed compound referred to in the peak group.",
                        null=True,
                        validators=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.RESTRICT, to="DataRepo.protocol"
            ),
        ),
        migrations.AddField(
            model_name="msrun",
            name="sample",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.RESTRICT, to="DataRepo.sample"
            ),
        ),
        migrations.AddField(
            model_name="animal",
