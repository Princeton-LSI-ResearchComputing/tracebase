...
def msrunprotocol_to_lcmethod(apps, _):
    ...
    method_map = [
        {
            # polar-HILIC-25-min
            "MATCHING_PATS": [HILIC_PAT],  # Must match all of these
            "UNMATCHING_PATS": [RP_LIPID_PAT, RP_IONPAIR_PAT, REVPHASE_PAT],  # Must not match any of these
            "MINS_IF_PRESENT": 25,
            "LC_REC": LCMethod.objects.get(name__exact="polar-HILIC-25-min")
        },
        {
            # polar-reversed-phase-25-min
            "MATCHING_PATS": [REVPHASE_PAT],  # Must match all of these
            "UNMATCHING_PATS": [RP_LIPID_PAT, RP_IONPAIR_PAT, HILIC_PAT],  # Must not match any of these
            "MINS_IF_PRESENT": 25,
            "LC_REC": LCMethod.objects.get(name__exact="polar-reversed-phase-25-min")
        },
        {
            # lipid-reversed-phase-25-min
            "MATCHING_PATS": [REVPHASE_PAT, RP_LIPID_PAT],  # Must match all of these
            "UNMATCHING_PATS": [RP_IONPAIR_PAT, HILIC_PAT],  # Must not match any of these
            "MINS_IF_PRESENT": 25,
            "LC_REC": LCMethod.objects.get(name__exact="lipid-reversed-phase-25-min")
        },
        {
            # polar-reversed-phase-ion-pairing-25-min
            "MATCHING_PATS": [REVPHASE_PAT, RP_IONPAIR_PAT],  # Must match all of these
            "UNMATCHING_PATS": [RP_LIPID_PAT, HILIC_PAT],  # Must not match any of these
            "MINS_IF_PRESENT": 25,
            "LC_REC": LCMethod.objects.get(name__exact="polar-reversed-phase-ion-pairing-25-min")
        },
    ]
