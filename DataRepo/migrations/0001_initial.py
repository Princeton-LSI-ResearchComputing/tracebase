# Generated by Django 3.2.5 on 2022-05-20 22:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(editable=False, help_text="A unique name or lab identifier of the infusate 'recipe' containing 1 or more tracer compounds at specific concentrations.", max_length=256, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(editable=False, help_text='An automatically maintained identifier of a tracer label.', max_length=256)),
        ...
        migrations.AddField(
            model_name='infusate',
            name='tracers',
            field=models.ManyToManyField(help_text="Tracers included in this infusate 'recipe'.", related_name='infusates', through='DataRepo.InfusateTracer', to='DataRepo.Tracer'),
        ),
        migrations.CreateModel(
