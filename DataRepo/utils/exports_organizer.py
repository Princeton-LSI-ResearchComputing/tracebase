...
class ExportsOrganizer:
    ...
    # TODO: Add an argument named mark_pending (bool) that appends .pending to created file anmes and removes .pending
    # from all input export files and zip archives when done.
    ...
    def organize_exports_by_study_and_datatype(self, files):
        ...
        for file in sorted(files):
            host, date_str, slugged_study_name, study_key, data_type, ext = (
    ...
    def files_differ(cls, filepath1: str, filepath2: str):
        ...
        """
        ext1: str = os.path.splitext(filepath1)[1]
        ext2: str = os.path.splitext(filepath2)[1]
        if ext1 != ext2:
            raise ValueError(
    ...
    def filepaths_to_zip(self, filepaths: List[str], zip_filepath: str):
        ...
        with zipfile.ZipFile(
            ...
            for file_path in filepaths:
                zipf.write(
                    file_path, arcname=os.path.relpath(file_path, start=self.export_dir)
                )
