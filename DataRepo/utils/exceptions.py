...
class AnimalsWithoutSamples(Exception):
    ...
    def __init__(self, exceptions: List[AnimalWithoutSamples]):
        ...
        message += (
            ...
            "these animals in the future either by resubmitting this ammended study doc or by submitting a new study "
    ...
    def __init__(self, animal: str, message: Optional[str] = None, **kwargs):
        ...
        if "suggestion" not in kwargs.keys() or kwargs["suggestion"] is None:
            message += (
                ...
                "this animal in the future either by resubmitting this ammended study doc or by submitting a new study "
